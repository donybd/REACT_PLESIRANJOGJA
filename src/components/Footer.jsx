					...
					<div className="mt-1">
						<ul className="nav justify-content-center">
							<li className="nav-item">
								<Link className="nav-link text-dark" to={`/discover`}>Discovery</Link>
							</li>
							<li className="nav-item">
								<Link className="nav-link text-dark" to={`/trip-tour`}>Trip</Link>
							</li>
							<li className="nav-item">
								<Link className="nav-link text-dark" to={`/rent`}>Rent</Link>
							</li>
							<li className="nav-item">
