      ...
      <div className="container">
        ...
        <div className="offcanvas bg-dark offcanvas-end" tabIndex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
          ...
          <div className="offcanvas-body">
            <ul className="navbar-nav ms-2 justify-content-center flex-grow-1 pe-3">
              ...
              <li className="nav-item">
                <Link to="/discover" className={`nav-link mx-lg-2 ${location.pathname === "/discover" || location.pathname === "/discover/culinary" || location.pathname === "/discover/culture" ? "active" : ""}`}>
                  Discover
                </Link>
              </li>
              <li className="nav-item">
                <Link to="/trip-tour" className={`nav-link mx-lg-2 ${location.pathname === "/trip-tour" ? "active" : ""}`}>
                  Trip&Tour
                </Link>
              </li>
              <li className="nav-item">
                <Link to="/hotel" className={`nav-link mx-lg-2 ${location.pathname === "/hotel" ? "active" : ""}`}>
                  Hotel
                </Link>
              </li>
              <li className="nav-item">
                <Link to="/rent" className={`nav-link mx-lg-2 ${location.pathname === "/rent" ? "active" : ""}`}>
                  Rental
                </Link>
              </li>
            </ul>
