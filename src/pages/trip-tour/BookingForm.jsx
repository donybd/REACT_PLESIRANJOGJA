	...
	return (
      ...
      <div className="txt-content">
        ...
        <form onSubmit={handleSubmit} method="POST">
          <label for="name" className="txt-form">Name</label>
          <input type="text" id="name" name="name" className="txt-form" />

          <label for="email" className="txt-form">Email</label>
          <input type="email" id="email" name="email" className="txt-form" />

          <label for="participants" className="txt-form">Number of Participants</label>
          ...
          <button type="submit" className="btn btn-custom mb-4">Book Now</button>
        </form>
      </div>
    </div>
	);
