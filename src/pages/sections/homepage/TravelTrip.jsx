			...
			<div className="container">
				<div className="row align-items-center">
					...
					<div className="col-lg-6">
						...
						<Link className="btn btn-about-us mt-3 justify-content-center" to={`/about-us`}>About Us</Link>
					</div>
				</div>
			</div>
		</section>
