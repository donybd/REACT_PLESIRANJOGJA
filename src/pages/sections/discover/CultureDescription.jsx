				...
				<div className="container">
					<div className="row mt-4">
						<div className="col-md-6">
							<h1>Visit Jogjakarta's <br />Most Famous <br />Culture</h1>
							<button className="btn"><Link to={`/discover/list-budaya`}>see more</Link></button>
						</div>
						<div className="col-md-6">
							<div className="card shadow" style={{ width: "100%" }}>
								...
								<div className="card-body p-3">
									...
									<Link to={`/discover/detail-budaya`} className="btn stretched-link">Read More</Link>
								</div>
							</div>
						</div>
					</div>
