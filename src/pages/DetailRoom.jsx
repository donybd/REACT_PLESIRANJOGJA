  ...
  <main>
    <div className="content-wrapper">
      ...
      <aside className="sidebar" style={{ width: "500px", padding: "10px" }}>
        ...
        <Link
          className="btn book-now-btn w-100"
          to={`/detail-hotel-payment`}
        >
          Book Now
        </Link>
      </aside>
  ...
  <section className="room-info">
    ...
    <div className="room-description">
      ...
      <div className="room-details">
        <div className="detail-item"><i className="fas fa-user"></i> Max Guest: 4</div>
        <div className="detail-item"><i className="fas fa-paw"></i> Pet: No</div>
        <div className="detail-item"><i className="fas fa-smoking-ban"></i> Smoking: No</div>
        <div className="detail-item"><i className="fas fa-ban"></i> Drug: No</div>
      </div>
