		...
		<>
			...
			<section className="location mt-2">
				<div className="container">
					...
					<p className="text-p">
						Gudeg Yu Djum is the main kitchen and traditional food stall in Yogyakarta, started by a person who never gives up, named Djuwariyah or known as "Yu Djum",
						since 1951. Djuwariyah first sold his gudeg in Widjilan Village, precisely to the south of Pelengkung Widjilan, At that time it was still a small shop with
						very simple tables and chairs. Djuwariya never gave up selling his gudeg. By using a pedicab to go home in the morning, little by little he accumulated
						capital to buy land and build a house. In 1985, the Gudeg Yu Djum food stall opened in Widjilan.
					</p>
				</div>
			</section>
				...
				<div className="review-list">
					...
					<div className="review-item">
						...
						<p className="review-text">
							I have visited 70 countries and lived in 7 - so I can credibly say that this is one of the best hotels in the world within its class. I also stayed here for 6.5 weeks, so got to know it well. Standout features of this hotel are
							its service, food, pool, and the best hotel gym I’ve ever seen, which includes a sauna with hot and cold plunge pools.
						</p>
						<div className="helpful">Helpful? Yes</div>
					</div>
					...
					<div className="review-item">
						...
						<p className="review-text">
							For reason business, vacation etc. This hotel is the best. Why?? Because The room so cleanned, delicious breakfast, the best facility swimming pool,gymnastic, Excellent service from check-in untuk check-out and the best service
							from room attendant (utta), I recommend this hotel for you.
						</p>
						<div className="helpful">Helpful? Yes</div>
					</div>
				</div>
